...
//   originalSentence.split('').forEach((char, i) => {
//     if (['.', ',', '!', '?'].includes(char)) {
//       sentence = sentence.slice(0, i) + char + sentence.slice(i + 1);
//     }
//   });
...
//   const selectedSentence = normalizeSentence(selectedWords.filter(w => w !== undefined && w !== "").join(" "));
//   const correctSentence = normalizeSentence(currentSentence.norwegian);
//   const formattedSelectedSentence = formatSentence(selectedSentence, currentSentence.norwegian);
//   const formattedCorrectSentence = formatSentence(correctSentence, currentSentence.norwegian);
...
//       selectedWords = words;
//       const selectedSentence = selectedWords.filter(w => w !== undefined && w !== "").join(" ").replace(/\s*([,\.!?])\s*/g, "$1 ");
//       const formattedSentence = formatSentence(selectedSentence, currentSentence.norwegian);
